...
const players = [
    ...
    {
        name: 'FLORES FLORES, ANDY ISMAEL',
        min: 0,
        goals: 0,
        redCards: 0,
        yellowCards: 0,
    ...
    {
        name: 'FERRERO SIXTO, JUAN ANTONIO',
        min: 0,
        goals: 0,
        redCards: 0,
        yellowCards: 0,
    ...
    {
        name: 'DE LA FUENTE GUILLEN, JOSE LUIS',
        min: 0,
        goals: 0,
        redCards: 0,
        yellowCards: 0,
    ...
    {
        name: 'VELASQUEZ GONZALES, JONAYKER ERNESTO',
        min: 0,
        goals: 0,
        redCards: 0,
        yellowCards: 0,
...
async function processGamePlay(day) {
    ...
    let gameReportLink = '';
    await page.goto(`https://www.futgal.es/pnfg/NPcd/NFG_CmpJornada?cod_primaria=1000120&CodCompeticion=20005937&CodGrupo=22389864&CodTemporada=20&cod_agrupacion=1&CodJornada=${day}`);
...
function printReport() {
    ...
    players.map(player => {
        ...
        player['goalsPerGame'] = Number.isNaN(goalsPerGame) ? 0 : goalsPerGame.toFixed(4);
    });
