...
const gameDay = Array.from({ length: 19 }, (e, i) => i).slice(1)
const players = [
    {
    ...
    {
        name: 'DA SILVA RODRIGUEZ, ADRIAN',
        min: 0,
        goals: 0,
        redCards: 0,
        yellowCards: 0,
...
async function processGamePlay(day) {
    ...
    let gameReportLink = '';
    await page.goto(`https://www.futgal.es/pnfg/NPcd/NFG_CmpJornada?cod_primaria=1000120&CodCompeticion=24123231&CodGrupo=24820914&CodTemporada=21&CodJornada=${day}`);
